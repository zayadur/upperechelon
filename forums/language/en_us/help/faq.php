...
$lang = array_merge($lang, array(
	'HELP_FAQ_ATTACHMENTS_ALLOWED_ANSWER'	=> 'Each board administrator can allow or disallow certain attachment types. If you are unsure what is allowed to be uploaded, contact a board administrator for assistance.',
	...
	'HELP_FAQ_BLOCK_ISSUES'	=> 'Board Issues',
	...
	'HELP_FAQ_BOOKMARKS_DIFFERENCE_ANSWER'	=> 'Bookmarking topics works much like bookmarking in a web browser. You are not alerted when there was an update. Bookmarking is more like subscribing to a topic. You are notified when a bookmarked topic is updated. Subscribing, however, will notify you when there is an update to a topic or forum on the board. Notification options for bookmarks and subscriptions can be configured in the User Control Panel, under “Board preferences”.',
	...
	'HELP_FAQ_FORMATTING_GLOBAL_ANNOUNCE_ANSWER'	=> 'Global announcements contain important information and you should read them whenever possible. They will appear at the top of every forum and within your User Control Panel. Global announcement permissions are granted by a board administrator.',
	...
	'HELP_FAQ_FORMATTING_ICONS_ANSWER'	=> 'Topic icons are author chosen images associated with posts to indicate their content. The ability to use topic icons depends on the permissions set by a board administrator.',
	...
	'HELP_FAQ_GROUPS_COLORS_ANSWER'	=> 'It is possible for a board administrator to assign a color to the members of a usergroup to make it easy to identify the members of this group.',
	'HELP_FAQ_GROUPS_COLORS_QUESTION'	=> 'Why do some usergroups appear in a different color?',
	'HELP_FAQ_GROUPS_DEFAULT_ANSWER'	=> 'If you are a member of more than one usergroup, your default is used to determine which group color and group rank should be shown for you by default. A board administrator may grant you permission to change your default usergroup via your User Control Panel.',
	...
	'HELP_FAQ_GROUPS_TEAM_QUESTION'	=> 'What is “Team” link?',
	...
	'HELP_FAQ_ISSUES_ADMIN_ANSWER'	=> 'All users of the board can use the “Contact us” form, if the option was enabled by a board administrator.<br />Members of the board can also use the “Team” link.',
	'HELP_FAQ_ISSUES_ADMIN_QUESTION'	=> 'How do I contact a board administrator?',
	'HELP_FAQ_ISSUES_FEATURE_ANSWER'	=> 'If you believe a feature needs to be added please post a topic in the Feedback forum, where you can browse ideas or suggest new features.',
	'HELP_FAQ_ISSUES_FEATURE_QUESTION'	=> 'Why isn’t a feature available?',
	'HELP_FAQ_ISSUES_LEGAL_ANSWER'	=> 'Any of the administrators listed on the “Team” page should be an appropriate point of contact for your complaints.',
	'HELP_FAQ_ISSUES_LEGAL_QUESTION'	=> 'Who do I contact about abusive and/or legal matters related to this board?',
	'HELP_FAQ_ISSUES_WHOIS_PHPBB_ANSWER'	=> 'Acknowledgements and attributions can be found <a href="https://upperechelon.gg/forums/credits.php">here</a>. The customizations and features of this board were developed by <a href="http://www.zayadur.com">lord_zader</a>.',
	'HELP_FAQ_ISSUES_WHOIS_PHPBB_QUESTION'	=> 'Who owns this board?',
	...
	'HELP_FAQ_PMS_CANNOT_SEND_ANSWER'	=> 'There are three reasons for this; you are not registered and/or not logged on, a board administrator has disabled private messaging for the entire board, or a board administrator has prevented you from sending messages. Contact a board administrator for more information.',
	'HELP_FAQ_PMS_CANNOT_SEND_QUESTION'	=> 'I cannot send private messages!',
	'HELP_FAQ_PMS_SPAM_ANSWER'	=> 'We are sorry to hear that. The email form feature of this board includes safeguards to try and track users who send such posts, so email a board administrator with a full copy of the email you received. It is very important that this includes the headers that contain the details of the user that sent the email. A board administrator can then take action.',
	...
	'HELP_FAQ_POSTING_NO_ATTACHMENTS_ANSWER'	=> 'Attachment permissions are granted on a per forum, per group, or per user basis. A board administrator may not have allowed attachments to be added for the specific forum you are posting in, or perhaps only certain groups can post attachments. Contact a board administrator if you are unsure about why you are unable to add attachments.',
	'HELP_FAQ_POSTING_NO_ATTACHMENTS_QUESTION'	=> 'Why can’t I add attachments?',
	'HELP_FAQ_POSTING_POLL_ADD_ANSWER'	=> 'The limit for poll options is set by a board administrator. If you feel you need to add more options to your poll than the allowed amount, contact a board administrator.',
	...
	'HELP_FAQ_POSTING_QUEUE_ANSWER'	=> 'A board administrator may have decided that posts in the forum you are posting to require review before submission. It is also possible that the administrator has placed you in a group of users whose posts require review before submission. Please contact a board administrator for further details.',
	'HELP_FAQ_POSTING_QUEUE_QUESTION'	=> 'Why does my post need to be approved?',
	'HELP_FAQ_POSTING_REPORT_ANSWER'	=> 'If a board administrator has allowed it, you should see a button for reporting posts next to the post you wish to report. Clicking this will walk you through the steps necessary to report the post.',
	...
	'HELP_FAQ_POSTING_WARNING_ANSWER'	=> 'There is a set of rules that users should adhere to. If you have broken a rule, you may be issued a warning. Contact a board administrator if you are unsure about why you were issued a warning.',
	...
	'HELP_FAQ_SEARCH_NO_RESULT_ANSWER'	=> 'Your search was probably too vague and included many common terms which are not indexed by this website. Be more specific and use the options available within Advanced search.',
	...
	'HELP_FAQ_USERSETTINGS_AVATAR_DISPLAY_ANSWER'	=> 'Within your User Control Panel, under “Profile” you can add an avatar by using one of the four following methods: Gravatar, Gallery, Remote or Upload. It is up to a board administrator to enable avatars and to choose the way in which avatars can be made available. If you are unable to use avatars, contact a board administrator.',
